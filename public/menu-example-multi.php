<?php
//  function definition in-lined for example.
//  Normally, would put it in a different file

function selectDistinctMulti ($connection, $tableName, $attributeName,
                           $pulldownName, $defaultValue)
{
     ...
     print "\n<select multiple name=\"{$pulldownName}\">";
...
<form action = "get-mult-input-example.php" method="GET">
<?php
...
selectDistinctMulti ($connection, $tableName, $attributeName,
                           $pulldownName, $defaultValue)
